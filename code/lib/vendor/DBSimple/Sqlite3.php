 ...
 * DbSimple_Sqlite3: Sqlite3 database.
...
class DbSimple_Sqlite3 extends DbSimple_Generic_Database

{
...

	{
		...
		if (!class_exists('SQLite3'))
			...
			return $this->_setLastError("-1", "SQLite extension is not loaded - юзайте PDO", $connect);

		/**

		 * Пока не реализовано - у меня в пакетах его нету - юзайте PDO
